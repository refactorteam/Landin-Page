...
$Comments= "<center><b>Участие в PRE-ICO Refactor.pro | EN</b></center> <br/><br/><hr/><br/> E-mail: <b>".$mail." <br/><br/> <hr/> ".$Comments;
        ...
        <div class="container">
                ...
                <div class="d-flex menu-m-content">
                    <div class="menu-m-left">
                        <ul class="navbar-nav">
							...
							-->
                            <li class="nav-item">
                                <a class="header-link" href="#">Bounty Campaign</a>
                            </li>
                            <li class="nav-item">
                                <a class="header-link special" href="#">Buy tokens</a>
                            </li>
                        </ul>
                    </div>
            ...
            <nav class="header navbar navbar-expand-lg navbar-dark">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="header-link" href="#product">Product</a>
                        </li>
                        <li class="nav-item">
                            <a class="header-link" href="#roadmap">Roadmap</a>
                        </li>
                        <li class="nav-item">
                            <a class="header-link" href="#team">Team</a>
                        </li>
                    </ul>
                    <div class="header-button-row my-2 my-lg-0">
                        <a href="/FAQ" class="header-button no-shadow">FAQ</a>
                        <a href="" class="login-button header-button circled shadow-hover"><i class="person"></i><span class="login-button_text">Login/Sign up</span></a>
                        <div class="dropdown">
                            <button class="btn lang-button dropdown-toggle" type="button" id="langFloatButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="img/gb.png"  width="25" height="20"> EN </button>
                            <div class="dropdown-menu dropdown-menu-right lang-dropdown" aria-labelledby="langFloatButton">
                                <a class="dropdown-item active" href="#"><img src="img/gb.png"  width="25" height="20"> English </a>
            ...
            <div class="topper-content">
                <div class="topper-content-left">
                    ...
                    <p class="topper-sub">powered by blockchain</p>
                    <div class="btn-group">
        ...
        <nav class=" follow-header navbar navbar-expand-md navbar-dark">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                    ...
                    <div class="header-button-row my-2 my-lg-0">
                        <a href="" class="header-button fill circled shadow-hover bold" id="pulseBottomButton">Buy tokens</a>
            ...
            <article class="receivable about-article">
                ...
                <div class="show d-flex putDown" id="tr1">
                        ...
                        <div class="line line-right">
                            ...
                            <div class="item">
                                <div class="item-wrapper center">
                                    ...
                                    <span class="item-desc">Goods and services</span>
                                </div>
                            </div>
                        </div>
                        <h1 class="between-c center">Trade receivables</h1>
                        <div class="line line-left">
                            <div class="line-left_bg"></div>
                            <div class="item">
                                <div class="item-wrapper center">
                                    <span class="item-desc">Deferred payment</span>
                                    <div class="item-img"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="show-card customer">
                        ...
                        <span class="show-card-sub">Customer</span>
                    </div>
                </div>
                    ...
                    <div class="show-mobile-left">
                        ...
                        <div class="line line-left">
                            ...
                            <div class="item">
                                <div class="item-wrapper center">
                                    <div class="item-img"></div>
                                    <span class="item-desc">Goods</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="between">
                        <h1 class="between-c center">Trade<br>recei<br>vable</h1>
                    </div>
                ...
                <p class="about-article_text center">Very often suppliers ship goods on credit terms, so that the customer<br>could have enough time to utilize them or resell. As soon as shipment is made, but no money has been paid by the customer,<br>its debt is reflected in supplier’s balance sheet as a trade receivable.</p>
            </article>
            <article class="idea about-article" id="idea">
                <h2 class="caption center">Core idea</h2>
                <div class="idea-show show d-flex center" id="complex2">
                    <div class="idea-show-card debt">
                        ...
                        <span class="show-card-sub">Emerging<br>markets</span>
                        <div class="line">
                            <span class="line-text">Trade<br>receivables</span>
                    ...
                    <div class="idea-show-card idea-between">
                        ...
                        <span class="show-card-sub idea-between-sub">Tradable<br>asset</span>
                        <span class="center-text center">Global P2P<br>trading</span>
                    ...
                    <div class="idea-show-card inv">
                        ...
                        <span class="show-card-sub">Global<br>community</span>
                        <div class="line">
                            <span class="line-text">Investments</span>
                            <div class="line-bg"></div>
                        </div>
                    </div>
                </div>
                <div class="idea-show idea-show-mobile show d-flex center" id="complex2">
                    <div class="idea-show-card debt">
                        ...
                        <span class="show-card-sub">Debt</span>
                        <div class="line">
                            <span class="line-text">Trade<br>receivables</span>
                            <div class="line-bg"></div>
                        </div>
                    ...
                    <div class="idea-show-card inv">
                        ...
                        <span class="show-card-sub">Private<br>investor</span>
                        <div class="line">
                            <span class="line-text">Investments</span>
                            <div class="line-bg"></div>
                        </div>
                ...
                <p class="about-article_text center">re:factor provides the financial market with a P2P factoring platform<br>to facilate investing in trade receivables and make the process global</p>
            </article>
        </div>
    </section>
    <section class="structure" id="product">
        <div class="container">
            <h2 class="caption center">re:factor platform</h2>
            <div class="structure-wrapper">
                <div class="structure-left structure-side">
                    ...
                    <ul class="structure-left_bottom structure-list" id="strDesc2">
                        <li class="structure-list_item">
                            <p class="structure-list_item__text">"Non-Factorable"
                                <br>Suppliers</p>
                            <div class="structure-list_item__pointer"></div>
                        </li>
                        <li class="structure-list_item">
                            <p class="structure-list_item__text">Institutional and rich private investors</p>
                            <div class="structure-list_item__pointer"></div>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="structure-wheel-row row">
                        <div class="structure-wheel-item" id="structure1">
                            ...
                            <div class="keeper" data-desc="strDesc1">
                                ...
                                <p class="keeper-text">Classical factoring company operating in target countries</p>
                            </div>
                        </div>
                        <div class="structure-wheel-item" id="structure2">
                            ...
                            <div class="keeper" data-desc="strDesc3">
                                ...
                                <p class="keeper-text">Global P2P receivables trading platform for regular receivables sellers.</p>
                            </div>
                        </div>
                    </div>
                    <div class="structure-wheel-row row">
                        <div class="structure-wheel-item" id="structure3">
                            ...
                            <div class="keeper" data-desc="strDesc2">
                                ...
                                <p class="keeper-text">Trade receivables exchange</p>
                            </div>
                        </div>
                        <div class="structure-wheel-item" id="structure4">
                            ...
                            <div class="keeper" data-desc="strDesc4">
                                ...
                                <p class="keeper-text">Outsource services for financial institutions and companies for trade receivables management and support.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="structure-right structure-side">
                    <ul class="structure-right_top structure-list" id="strDesc3">
                        <li class="structure-list_item">
                            <p class="structure-list_item__text">"Factorable" suppliers</p>
                            <div class="structure-list_item__pointer"></div>
                        </li>
                        <li class="structure-list_item">
                            <p class="structure-list_item__text">Private P2P investors</p>
                            <div class="structure-list_item__pointer"></div>
                        </li>
                    </ul>
            ...
            <div class="structure-wrapper-m">
                <div class="structure-left structure-side">
                    ...
                    <ul class="structure-right_top structure-list" id="strDesc3">
                        <li class="structure-list_item more">
                            <p class="structure-list_item__text">Institutional investors
                                <br>and Ultra High Worth
                                <br>Individuals</p>
                            <div class="structure-list_item__pointer pointing"></div>
                        </li>
                        <li class="structure-list_item">
...
<div class="min-right-yt"></div>
            ...
            <div class="container">
                <div class="min-wrapper d-flex">
                    ...
                    <div class="min-left">
                        ...
                        <ul class="min-list">
                            <li class="min-desc min-list-item">Turns trade receivables into a liquid asset</li>
                            <li class="min-desc min-list-item">Lifting national borders between platform users</li>
                            <li class="min-desc min-list-item">Granting access to financing for SMEs in emerging markets</li>
                            <li class="min-desc min-list-item">Develops economies for of countries of re:factors’s presence</li>
                            <li class="min-desc min-list-item">Makes the investment process safe</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="roadmap-top">
                    ...
                    <div class="roadmap-top-slider d-flex">
                        ...
                        <div class="roadmap-card d-flex">
                            ...
                            <span class="roadmap-card_desc">Preliminary contract settlement with retailers and financial institutes in target countries</span>
                        </div>
                        <div class="roadmap-card d-flex">
                            <div class="roadmap-card_img">
                                <div class="roadmap-card_img__symbol" style="background-image: url(img/road/5.svg); width: 72px; height: 72px;"></div>
                            </div>
                            <span class="roadmap-card_desc">Business-model stress-testing, technical concept design</span>
                        </div>
                        <div class="roadmap-card d-flex">
                            <div class="roadmap-card_img">
                                <div class="roadmap-card_img__symbol" style="background-image: url(img/road/6.svg); width: 72px; height: 72px;"></div>
                            </div>
                            <span class="roadmap-card_desc">Whitepaper ICO, MVP design</span>
                        </div>
                        <div class="roadmap-card d-flex">
                            <div class="roadmap-card_img">
            ...
            <div class="container">
                <div class="roadmap-bottom-wrapper d-flex">
                    ...
                    <div class="roadmap-bottom-thing d-flex" data-date="2017-7">
                        ...
                        <!-- <img src="img/team/1.png" alt="Mikhail Treyvish" class="roadmap-card_img"> -->
                        <span class="roadmap-bottom-desc">Jul, 2017 - Aug, 2017</span>
                    </div>
                    ...
                    <div class="roadmap-bottom-thing d-flex" data-date="2017-9">
                        ...
                        <!-- <img src="img/team/1.png" alt="Mikhail Treyvish" class="roadmap-card_img"> -->
                        <span class="roadmap-bottom-desc">Nov, 2017 - Dec, 2017</span>
                    </div>
                    <div class="roadmap-bottom-thing d-flex" data-date="2018-2">
                        <div class="roadmap-bottom-dot">
                        </div>
                        <!-- <img src="img/team/1.png" alt="Mikhail Treyvish" class="roadmap-card_img"> -->
                        <span class="roadmap-bottom-desc">Jan, 2018 - Mar, 2018</span>
                    </div>
                    <div class="roadmap-bottom-thing d-flex" data-date="2018-4">
                        <div class="roadmap-bottom-dot">
                        </div>
                        <!-- <img src="img/team/1.png" alt="Mikhail Treyvish" class="roadmap-card_img"> -->
                        <span class="roadmap-bottom-desc">Apr, 2018</span>
                    </div>
                    ...
                    <div class="roadmap-bottom-thing d-flex" data-date="2018-7">
                        ...
                        <!-- <img src="img/team/1.png" alt="Mikhail Treyvish" class="roadmap-card_img"> -->
                        <span class="roadmap-bottom-desc">Jul, 2018 - Aug, 2018</span>
                    </div>
                    ...
                    <div class="roadmap-bottom-thing d-flex" data-date="2018-11">
                        ...
                        <!-- <img src="img/team/1.png" alt="Mikhail Treyvish" class="roadmap-card_img"> -->
                        <span class="roadmap-bottom-desc">Dec, 2018</span>
                    </div>
                    <div class="roadmap-bottom-thing d-flex" data-date="2018-12">
                        <div class="roadmap-bottom-dot">
                        </div>
                        <!-- <img src="img/team/1.png" alt="Mikhail Treyvish" class="roadmap-card_img"> -->
                        <span class="roadmap-bottom-desc">Jan, 2019</span>
                    </div>
    ...
    <section class="economy" id="economy">
        <div class="container">
            <h1 class="caption center">ICO details</h1>
                ...
                <div class="economy-around">
                    <div class="economy-diagram">
                        <div class="economy-diagram-wrapper">
                            ...
                            <p class="economy-desc center">Maximum volume
                                <br>of REFT tokens issue</p>
                        </div>
                    </div>
                    <div class="economy-description">
                        <div class="economy-left">
                            <div class="economy-thing">
                                ...
                                <p class="economy-desc">Max volume of REFT
                                    <br>Tokens sold out during ICO</p>
                                <div class="economy-round" style="opacity: 1;"></div>
                            </div>
                            <div class="economy-thing">
                                <h2 class="economy-number">200<span class="economy-b">mln</span></h2>
                                <p class="economy-desc">Number of REFT Tokens
                                    <br>reserved for the team</p>
                        ...
                        <div class="economy-right">
                            ...
                            <div class="economy-thing">
                                <h2 class="economy-number">10<span class="economy-b">mln</span></h2>
                                <p class="economy-desc">Advisers</p>
                                <div class="economy-round" style="opacity: .2;"></div>
                            </div>
                            <div class="economy-thing">
                                <h2 class="economy-number">10<span class="economy-b">mln</span></h2>
                                <p class="economy-desc">Referral investors</p>
                                <div class="economy-round" style="opacity: .1;"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="economy-buy center">
                <a href="" class="header-button gradient circled center economy-button bold">Buy tokens</a>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="footer-top d-flex">
                    <div class="footer-section">
                        <h2 class="footer-section_caption">Menu</h2>
                        <ul class="footer-list menu">
							...
							-->
                            <li class="footer-list_item"><a href="" class="footer-list_item__link">Bounty campaign</a>
                            </li>
                        </ul>
                    </div>
                    <div class="footer-section">
                        <div class="footer-section-division">
                            <h2 class="footer-section_caption">Contact us</h2>
                        ...
                        <div class="footer-section-division">
                            <h2 class="footer-section_caption">Join us</h2>
                            <ul class="social-list d-flex">
                                <li class="social-list_item"><a href="https://t.me/refactor_rus" target="_blank" class="social-list_item__link"><i class="fab fa-telegram-plane"></i></a>
                                </li>
                                <li class="social-list_item"><a href="https://twitter.com/refactor_ico" target="_blank" class="social-list_item__link"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="footer-section">
                        <h2 class="footer-section_caption">Documents</h2>
                        <ul class="footer-list menu">
                    ...
                    <div class="footer-section sub">
                        <h2 class="footer-section_caption">Get news on<br>developments</h2>
                        <form method="post" action="<?= $_SERVER['REQUEST_URI'];?>" class="footer-form">
                            <input type="email" name="mail" class="footer-email d-block" id="inputEmail" placeholder="Enter email" required>
                            <button type="submit" class="header-button circled shadow hovered scale fill d-block footer-button">Stay tuned</button>
                        </form>
                    </div>
                </div>
